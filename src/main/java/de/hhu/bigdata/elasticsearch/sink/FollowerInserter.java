...
/**
 * Allows to sink a @{@link de.hhu.bigdata.processing.stream.apply.AvgFollower} into the elasticSearch index
 */
public class FollowerInserter implements ElasticsearchSinkFunction<Tuple3<String, Float, Long>> {
	@Override
